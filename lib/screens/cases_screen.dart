...
class CasesScreen extends StatefulWidget {
  static String routeName = 'cases screen';
  @override
...
class _CasesScreenState extends State<CasesScreen>
  ...
  Future<bool> getEmps() async {
    await Provider.of<CaseProvider>(context, listen: false).getCases(
        context: context,
        patID: Provider.of<ClientProvider>(context, listen: false)
            .selectedClient!
            .id
            .toString());
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    " اشتراكات المشترك : ${Provider.of<ClientProvider>(context, listen: false).selectedClient!.name!}       ",
                                    style: TextStyle(
                                      fontFamily: 'Cairo',
                                      fontWeight: FontWeight.bold,
                                      fontSize: 20,
